...
export const Resume = () => {
  ...
  useEffect(() => {
    // Remove scroll-based functionality for now
  }, []);
  ...
  return (
    <section id="resume" className="py-20 bg-[#2C3E50]">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="py-20 px-4 bg-[#2C3E50]" id="project-portfolio">
            ...
            <div className="relative max-w-4xl mx-auto">
              ...
              <div className="relative space-y-8">
                ...
                <div className="relative mb-4">
                  <div className="relative">
                    {/* Folder Tab - Website colors */}
                    <div className="absolute -top-6 left-8 z-10">
                      <div 
                        className="bg-[#7A9CA9] border-l-4 border-t-4 border-r-4 border-[#2C3E50] rounded-t-lg px-6 py-2 shadow-lg cursor-pointer hover:bg-[#7A9CA9]/80 transition-colors duration-200"
