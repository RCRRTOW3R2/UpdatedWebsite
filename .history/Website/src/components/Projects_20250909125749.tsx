...
export const Resume = () => {
  const timelineItems: TimelineItem[] = [
    ...
    },
    {
      ...
      description: 'Developed and launched multiple websites for Vibe Coding, a company focused on web development and digital marketing. This experience deepened my understanding of web technologies and project management.',
      type: 'project' as const,
      side: 'left' as const
    },
    {
