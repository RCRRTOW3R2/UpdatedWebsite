              ...
              <div className="bg-[#F0F0E8] rounded-xl p-8 shadow-xl border-2 border-[#7A9CA9]/30">
                ...
                <div className="flex justify-center mb-6">
                  <img
                    ...
                    className="w-32 h-40 object-cover rounded-lg shadow-lg border-2 border-[#7A9CA9]/30 transition-all duration-500 ease-in-out"
                  />
                </div>
                ...
                <div className="space-y-3 text-center">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-[#7A9CA9] font-bold">23</span>
                  </div>
                  <div className="flex justify-between items-center">
