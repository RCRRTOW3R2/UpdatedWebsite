...
export const Resume = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      // Auto-open folders based on scroll position within the project section
      const projectSection = document.getElementById('project-portfolio');
      if (projectSection) {
        const rect = projectSection.getBoundingClientRect();
        const windowHeight = window.innerHeight;
        
        // Calculate how far into the section we've scrolled (0 = top, 1 = bottom)
        ...
        if (sectionTop < windowHeight && (sectionTop + sectionHeight) > 0) {
          ...
          const scrollProgress = Math.max(0, Math.min(1, (viewportMiddle - sectionTop) / sectionHeight));
          
          // Open folders based on scroll progress - only one at a time
          if (scrollProgress < 0.2) {
            setOpenFolder(null);
          } else if (scrollProgress >= 0.2 && scrollProgress < 0.4) {
            setOpenFolder('epl-prophet');
          } else if (scrollProgress >= 0.4 && scrollProgress < 0.6) {
            setOpenFolder('tandem-app');
          } else if (scrollProgress >= 0.6 && scrollProgress < 0.8) {
            setOpenFolder('vibe-coding');
          } else if (scrollProgress >= 0.8) {
            setOpenFolder('portfolio-site');
          }
        }
      }
    };
            ...
            <div className="relative max-w-4xl mx-auto">
              ...
              <div className="relative space-y-8">
                  ...
                  <div className="relative transform transition-all duration-500 ease-out">
                    <div className="relative">
                      {/* Folder Body */}
                      <div className={`bg-gradient-to-br from-[#F4E4BC] to-[#E8D5A3] rounded-lg shadow-2xl border-4 border-[#8B7355] transition-all duration-700 ease-out ${
                        openFolder === 'epl-prophet' 
                          ? 'transform translate-y-0 scale-100 opacity-100' 
                          : 'transform translate-y-2 scale-98 opacity-90'
                      }`}>
                        
                        {/* Folder Tab - Positioned relative to folder body */}
                        <div className="absolute -top-6 left-8 z-10">
                          <div className="bg-gradient-to-r from-[#F4E4BC] to-[#E8D5A3] border-l-4 border-t-4 border-r-4 border-[#8B7355] rounded-t-lg px-6 py-2 shadow-lg">
                  ...
                  <div className="relative transform transition-all duration-500 ease-out">
                    <div className="relative">
                      {/* Folder Body */}
                      <div className={`bg-gradient-to-br from-[#D4E6F1] to-[#AED6F1] rounded-lg shadow-2xl border-4 border-[#5D8AA8] transition-all duration-700 ease-out ${
                        ...
                        <div className="absolute -top-6 right-8 z-10">
                          <div className="bg-gradient-to-r from-[#D4E6F1] to-[#AED6F1] border-l-4 border-t-4 border-r-4 border-[#5D8AA8] rounded-t-lg px-6 py-2 shadow-lg">
                  ...
                  <div className="relative transform transition-all duration-500 ease-out">
                    <div className="relative">
                      {/* Folder Body */}
                      <div className={`bg-gradient-to-br from-[#E8F5E8] to-[#C8E6C9] rounded-lg shadow-2xl border-4 border-[#66BB6A] transition-all duration-700 ease-out ${
                        ...
                        <div className="absolute -top-6 left-16 z-10">
                          <div className="bg-gradient-to-r from-[#E8F5E8] to-[#C8E6C9] border-l-4 border-t-4 border-r-4 border-[#66BB6A] rounded-t-lg px-6 py-2 shadow-lg">
                  ...
                  <div className="relative transform transition-all duration-500 ease-out">
                    <div className="relative">
                      {/* Folder Body */}
                      <div className={`bg-gradient-to-br from-[#F3E5F5] to-[#E1BEE7] rounded-lg shadow-2xl border-4 border-[#AB47BC] transition-all duration-700 ease-out ${
                        ...
                        <div className="absolute -top-6 right-16 z-10">
                          <div className="bg-gradient-to-r from-[#F3E5F5] to-[#E1BEE7] border-l-4 border-t-4 border-r-4 border-[#AB47BC] rounded-t-lg px-6 py-2 shadow-lg">
