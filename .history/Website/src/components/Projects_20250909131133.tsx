          ...
          <div className="relative max-w-4xl mx-auto">
            ...
            <div className="space-y-4">
              ...
              <div className="group relative">
                ...
                <div className="relative z-10">
                  <div 
                    ...
                    onMouseEnter={() => handleFolderHover('epl-prophet')}
                  >
                ...
                {/* Folder Content */}
                <div className={`absolute top-8 left-0 w-full bg-[#F0F0E8] rounded-lg shadow-2xl transition-all duration-500 ease-out z-20 border-2 border-[#7A9CA9]/30 ${
              ...
              <div className="group relative" style={{ marginLeft: '2rem' }}>
                <div className="relative z-10">
                  <div 
                    className="w-48 h-12 bg-gradient-to-r from-[#2C3E50] to-[#2C3E50]/80 rounded-t-lg flex items-center px-4 cursor-pointer transform transition-all duration-300 hover:scale-105 shadow-lg"
                    onMouseEnter={() => handleFolderHover('tandem-app')}
                  >
                    <span className="text-[#F0F0E8] font-semibold text-sm">Tandem App</span>
                  </div>
                </div>
                
                <div className={`absolute top-8 left-0 w-full bg-[#F0F0E8] rounded-lg shadow-2xl transition-all duration-500 ease-out z-20 border-2 border-[#2C3E50]/30 ${
              ...
              <div className="group relative" style={{ marginLeft: '4rem' }}>
                <div className="relative z-10">
                  <div 
                    ...
                    onMouseEnter={() => handleFolderHover('vibe-coding')}
                  >
                    <span className="text-[#F0F0E8] font-semibold text-sm">Vibe Coding</span>
                  </div>
                </div>
                
                <div className={`absolute top-8 left-0 w-full bg-[#F0F0E8] rounded-lg shadow-2xl transition-all duration-500 ease-out z-20 border-2 border-[#1E2A3B]/30 ${
              ...
              <div className="group relative" style={{ marginLeft: '6rem' }}>
                <div className="relative z-10">
                  <div 
                    className="w-48 h-12 bg-gradient-to-r from-[#243447] to-[#243447]/80 rounded-t-lg flex items-center px-4 cursor-pointer transform transition-all duration-300 hover:scale-105 shadow-lg"
                    onMouseEnter={() => handleFolderHover('portfolio-site')}
                  >
                    <span className="text-[#F0F0E8] font-semibold text-sm">Portfolio Site</span>
                  </div>
                </div>
                
                <div className={`absolute top-8 left-0 w-full bg-[#F0F0E8] rounded-lg shadow-2xl transition-all duration-500 ease-out z-20 border-2 border-[#243447]/30 ${
          ...
          <div className="max-w-6xl mx-auto bg-gradient-to-br from-[#1E2A3B] to-[#243447] rounded-xl p-8 border-2 border-[#7A9CA9]/30 shadow-2xl">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="flex flex-col items-center">
                ...
                <div className="w-full bg-[#2C3E50] rounded-lg p-4 border border-[#7A9CA9]/20">
                  <div className="flex justify-between text-sm text-[#7A9CA9] mb-2">
                    <span>Experience Points</span>
                    <span>15,420 / 20,000 XP</span>
                  </div>
                  <div className="w-full bg-[#1E2A3B] rounded-full h-3">
                    <div className="bg-gradient-to-r from-[#7A9CA9] to-[#A3C4D1] h-3 rounded-full transition-all duration-1000" style={{ width: '77%' }}></div>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  <h5 className="text-lg font-semibold text-[#7A9CA9] border-b border-[#7A9CA9]/30 pb-1">💻 Programming</h5>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex-1 bg-[#1E2A3B] rounded-full h-4 relative">
                      <div className="bg-gradient-to-r from-red-600 to-red-500 h-4 rounded-full transition-all duration-1000" style={{ width: '95%' }}></div>
                      <span className="absolute right-2 top-0 text-xs text-[#F0F0E8] leading-4">95</span>
                    </div>
                  </div>
                </div>
