...
export const Resume = () => {
  ...
  return (
    <section id="resume" className="py-20 bg-gradient-to-b from-[#3A5466] to-[#2F4553]">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="bg-gradient-to-b from-[#2F4553] to-[#243441] py-20 px-4" id="project-portfolio">
        ...
        <div className="mt-32">
          ...
          <div className="bg-gradient-to-b from-[#243441] to-[#1A252F] py-20 px-4">
