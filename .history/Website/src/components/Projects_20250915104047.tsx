                  ...
                  <div className={`flex ${item.side === 'left' ? 'justify-start pr-1/2' : 'justify-end pl-1/2'}`}>
                    <div className={`w-5/12 ${item.side === 'right' ? 'ml-auto' : 'mr-auto'}`}>
                      <div className="group relative">
                        {/* Title card - hidden on hover */}
                        <div className={`p-6 rounded-lg cursor-pointer transition-all duration-300 transform group-hover:scale-105 group-hover:opacity-0 ${
                          item.side === 'left'
                        ...
                        {/* Hover details - expands naturally */}
                        <div className={`absolute inset-0 opacity-0 group-hover:opacity-100 transition-all duration-300 z-20 pointer-events-none group-hover:pointer-events-auto`}>
                          <div className={`p-6 rounded-lg bg-[#1E2A3B] shadow-2xl border border-[#7A9CA9]/30 min-h-full flex flex-col justify-center ${item.side === 'left' ? 'text-right' : 'text-left'}`}>
