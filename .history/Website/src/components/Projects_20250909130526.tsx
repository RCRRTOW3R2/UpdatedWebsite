...
export const Resume = () => {
  ...
  const handleFolderLeave = () => {
    // Don't close immediately on mouse leave, let scroll handle it
  };
            ...
            <div className="space-y-4">
              ...
              <div className="group relative">
                ...
                <div className="relative z-10">
                  <div className="w-48 h-12 bg-gradient-to-r from-[#7A9CA9] to-[#7A9CA9]/80 rounded-t-lg flex items-center px-4 cursor-pointer transform transition-all duration-300 group-hover:scale-105 shadow-lg">
                    <span className="text-[#F0F0E8] font-semibold text-sm">EPL Prophet</span>
                  </div>
                </div>
                
                {/* Folder Content (Hidden by default, shows on hover) */}
                <div className="absolute top-8 left-0 w-full bg-[#F0F0E8] rounded-lg shadow-2xl opacity-0 group-hover:opacity-100 transform translate-y-4 group-hover:translate-y-0 transition-all duration-500 ease-out z-20 border-2 border-[#7A9CA9]/30">
                  <div className="p-8">
              ...
              {/* Tandem App Folder */}
              <div className="group relative" style={{ marginLeft: '2rem' }}>
                <div className="relative z-10">
                  <div className="w-48 h-12 bg-gradient-to-r from-[#2C3E50] to-[#2C3E50]/80 rounded-t-lg flex items-center px-4 cursor-pointer transform transition-all duration-300 group-hover:scale-105 shadow-lg">
                    <span className="text-[#F0F0E8] font-semibold text-sm">Tandem App</span>
                  </div>
                </div>
                
                <div className="absolute top-8 left-0 w-full bg-[#F0F0E8] rounded-lg shadow-2xl opacity-0 group-hover:opacity-100 transform translate-y-4 group-hover:translate-y-0 transition-all duration-500 ease-out z-20 border-2 border-[#2C3E50]/30">
                  <div className="p-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
                      <div className="order-2 md:order-1">
                        <img 
              ...
              {/* Vibe Coding Folder */}
              <div className="group relative" style={{ marginLeft: '4rem' }}>
                <div className="relative z-10">
                  <div className="w-48 h-12 bg-gradient-to-r from-[#1E2A3B] to-[#1E2A3B]/80 rounded-t-lg flex items-center px-4 cursor-pointer transform transition-all duration-300 group-hover:scale-105 shadow-lg">
                    <span className="text-[#F0F0E8] font-semibold text-sm">Vibe Coding</span>
                  </div>
                </div>
                
                <div className="absolute top-8 left-0 w-full bg-[#F0F0E8] rounded-lg shadow-2xl opacity-0 group-hover:opacity-100 transform translate-y-4 group-hover:translate-y-0 transition-all duration-500 ease-out z-20 border-2 border-[#1E2A3B]/30">
                  <div className="p-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
                      <div className="order-2 md:order-1">
                        <img 
              ...
              <div className="group relative" style={{ marginLeft: '6rem' }}>
                <div className="relative z-10">
                  <div className="w-48 h-12 bg-gradient-to-r from-[#243447] to-[#243447]/80 rounded-t-lg flex items-center px-4 cursor-pointer transform transition-all duration-300 group-hover:scale-105 shadow-lg">
                    <span className="text-[#F0F0E8] font-semibold text-sm">Portfolio Site</span>
                  </div>
                </div>
                
                <div className="absolute top-8 left-0 w-full bg-[#F0F0E8] rounded-lg shadow-2xl opacity-0 group-hover:opacity-100 transform translate-y-4 group-hover:translate-y-0 transition-all duration-500 ease-out z-20 border-2 border-[#243447]/30">
                  <div className="p-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
                      <div className="order-2 md:order-1">
                        <img 
