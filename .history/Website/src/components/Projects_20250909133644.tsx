...
export const Resume = () => {
  ...
  const handleFolderHover = (folderName: string) => {
    if (openFolder === folderName) {
      setOpenFolder(null); // Close if already open
    } else {
      setOpenFolder(folderName); // Open the clicked folder
    }
    setScrollDelta(0); // Reset scroll delta when clicking a folder
  };
        ...
        <div className="mt-32">
          ...
          <div className="relative max-w-7xl mx-auto px-4">
            ...
            <div className="space-y-6">
              {/* EPL Prophet Folder */}
              <div className="group relative folder-container">
                {/* Folder Tab */}
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex-1 bg-[#1E2A3B] rounded-full h-4 relative">
                      <div className="bg-gradient-to-r from-red-500 to-red-400 h-4 rounded-full transition-all duration-1000" style={{ width: '85%' }}></div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex-1 bg-[#1E2A3B] rounded-full h-4 relative">
                      <div className="bg-gradient-to-r from-blue-500 to-blue-400 h-4 rounded-full transition-all duration-1000" style={{ width: '78%' }}></div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex-1 bg-[#1E2A3B] rounded-full h-4 relative">
                      <div className="bg-gradient-to-r from-purple-500 to-purple-400 h-4 rounded-full transition-all duration-1000" style={{ width: '90%' }}></div>
