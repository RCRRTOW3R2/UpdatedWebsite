    ...
    const handleScroll = () => {
      ...
      if (projectSection) {
        ...
        if (sectionTop < windowHeight && (sectionTop + sectionHeight) > 0) {
          // Calculate progress (0 to 1) based on how much of section has passed viewport center
          const scrollProgress = Math.max(0, Math.min(1, (windowHeight / 2 - sectionTop) / sectionHeight));
          
          // Progressive folder opening - only one at a time
                ...
                <div className="relative mb-4">
                  <div className="relative">
                    ...
                    <div className={`bg-gradient-to-br from-[#F4E4BC] to-[#E8D5A3] rounded-lg shadow-2xl border-4 border-[#8B7355] transition-all duration-700 ease-out transform ${
                      openFolder === 'epl-prophet' 
                        ...
                        : 'translate-y-2 opacity-95 scale-98'
                    }`}>
                  ...
                  <div className="relative mb-4">
                    <div className="relative">
                      ...
                      {/* Folder Body */}
                      <div className={`bg-gradient-to-br from-[#D4E6F1] to-[#AED6F1] rounded-lg shadow-2xl border-4 border-[#5D8AA8] transition-all duration-700 ease-out transform ${
                  ...
                  <div className="relative mb-4">
                    <div className="relative">
                      ...
                      {/* Folder Body */}
                      <div className={`bg-gradient-to-br from-[#E8F5E8] to-[#C8E6C9] rounded-lg shadow-2xl border-4 border-[#66BB6A] transition-all duration-700 ease-out transform ${
                  ...
                  <div className="relative mb-4">
                    <div className="relative">
                      ...
                      {/* Folder Body */}
                      <div className={`bg-gradient-to-br from-[#F3E5F5] to-[#E1BEE7] rounded-lg shadow-2xl border-4 border-[#AB47BC] transition-all duration-700 ease-out transform ${
